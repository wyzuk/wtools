...
export function PhoneFormatterTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleFormat} className="p-6 bg-white dark:bg-[#1c1c1e] border border-slate-200 dark:border-white/10 rounded-2xl space-y-4 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_8px_24px_-4px_rgba(0,0,0,0.05)] transition-colors">
