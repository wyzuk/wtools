    ...
    ? [
        {
          ...
          value: (
            <span className="font-mono text-xs sm:text-sm font-bold text-blue-600 dark:text-blue-400 bg-slate-100 dark:bg-white/10 px-2.5 py-1 rounded border border-slate-200 dark:border-white/10">
