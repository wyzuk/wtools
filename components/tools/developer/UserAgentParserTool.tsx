...
export function UserAgentParserTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleParse} className="p-6 bg-white dark:bg-[#0d0d0d] border border-slate-200 dark:border-white/10 rounded-xl space-y-4 shadow-sm dark:shadow-none transition-colors">
        <div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
          ...
          <button
            type="submit"
            disabled={limitReached}
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-lg bg-blue-500 hover:bg-blue-600 disabled:opacity-50 text-white text-sm font-medium transition-colors shadow-sm shrink-0"
          >
