...
export function AsnLookupTool() {
  ...
  const items = data
    ? [
        ...
        { label: "Announced IPv4 Prefixes", value: data.ipv4_prefixes.toLocaleString(), mono: true },
        { label: "Announced IPv6 Prefixes", value: data.ipv6_prefixes.toLocaleString(), mono: true },
        { label: "Upstream Peers", value: data.upstreams_count.toLocaleString(), mono: true },
        { label: "Status", value: data.iana_assignment_status },
      ]
    : [];
